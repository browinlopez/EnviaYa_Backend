...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Negocios por tipo
        $businessTypes = Business::select('category_business_id', DB::raw('count(*) as total'))
            ->groupBy('category_business_id')
            ->pluck('total', 'category_business_id');
        ...
        $topProducts = Product::with(['businesses']) // 👈 aquí cargas el negocio
