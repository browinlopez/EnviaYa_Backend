            ...
            <div class="card-content">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <select name="type_document_identification_id" required>
                            @foreach ($TypeDocumentIdentifications as $type)
                                <option value="{{ $type->id }}" {{ $owner->type_document_identification_id == $type->id ? 'selected' : '' }}>
